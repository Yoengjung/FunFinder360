...
<body>
	<div class="top-container">
		...
		<div class="login-container">
			...
			<c:if test="${not empty sessionScope.loginfoOwner}">
				<ul>
					<li><span id="login-message">환영합니다 (업주)</span> <span>${sessionScope.loginfoOwner.userName}</span>
					</li>
			...
			<c:if test="${not empty sessionScope.loginfo}">
				<ul>
					<li><span id="login-message">환영합니다 (개인)</span> <span>${sessionScope.loginfo.username}님</span>
					</li>
					<li><a href="<%=notWithFormTag%>logout" class="a-tag">logout</a>
					</li>
				</ul>
