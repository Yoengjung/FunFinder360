	...
	<div class="container">
		...
		<div class="info-2">
			<div class="circle-container">
				<img
					src="${pageContext.request.contextPath}/common/image/문화_엔터테인먼트.jpg">
		...
		<div class="info-4">
			<div class="circle-container-4">
				...
				<img
					src="${pageContext.request.contextPath}/common/image/음식_요리.jpg">
			</div>
		</div>
		<div class="info-5">
			<div class="circle-container-5">
				<img
					src="${pageContext.request.contextPath}/common/image/교육_학습.jpg">
		...
		<div class="info-4">
			<div class="circle-container-4">
				...
				<img
					src="${pageContext.request.contextPath}/common/image/여행_모험.jpg">
			</div>
		</div>
	</div>
</body>
